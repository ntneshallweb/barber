            ...
            <form action="{{url('admin/prices/store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="title" placeholder="Enter Prices title" required autofocus>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" value="Haircut" id="customRadio1" name="type">
                            <label for="customRadio1" class="custom-control-label">HAIRCUT</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" value="Shave" id="customRadio2" name="type" >
