            ...
            <form action="{{ url('admin/categories/update',$categories->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $categories->subheading }}" name="subheading" id="subheading" placeholder="Enter Sub Heading" required autofocus>
                    </div>
                    <div class="form-group">
                        <strong>Descripton:</strong>
                        <textarea class="form-control textarea" name="descripton"  id="descripton" placeholder="Enter descripton" required>{{ $categories->descripton }}</textarea>
                    </div>
                </div>
                <!-- /.card-body -->
